...
public class NexusHttpException extends Exception {
    ...
    public NexusHttpException(String message) { super(message); }
    public NexusHttpException(String message, Throwable cause) { super(message, cause); }
    public NexusHttpException(Throwable cause) { super(cause); }
